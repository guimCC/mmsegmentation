...
model = dict(
    auxiliary_head=dict(
        ...
        in_index=2,
        loss_decode=dict(
            loss_weight=0.4, type='CrossEntropyRewardLoss', use_sigmoid=False),
        norm_cfg=dict(requires_grad=True, type='SyncBN'),
        num_classes=19,
        num_convs=1,
        type='ReinforceFCNHead'),
    backbone=dict(
    ...
    init_cfg=dict(
        checkpoint=
        '/home/gcasadella/mmsegmentation/workdir/easyportrait/implementation/deeplab_original_start/iter_40000.pth',
        type='Pretrained'),
...
work_dir = '/home/gcasadella/mmsegmentation/workdir/easyportrait/custom_loss/from_ckp_bigbatch'
