...
data_root = 'data/mapillary/mapillary_per_guim/'
dataset_type = 'MapillaryAsCityscapesDataset'
default_hooks = dict(
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        type='MapillaryAsCityscapesDataset'),
    num_workers=4,
...
work_dir = '/home/gcasadella/mmsegmentation/workdir/mapillary/implementation/raw/'
