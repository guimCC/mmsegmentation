...
optimizer = dict(type='SGD', # Type of optimiser
                 lr=0.0001, # Learning rate of optimisers 
...
param_scheduler = [
     dict(
         ...
         eta_min=1e-6, # Minimum learning rate at the end of sheduling
         power=0.9, # Power of polynomial decay
         begin=30000, # Step at which to start updating the parameters
         end=100000, # Step at which to stop updating the parameters
